...
const BlogsFilters = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-8 items-start sm:items-center justify-between">
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-grow sm:max-w-[300px]">
          ...
          <input
            ...
            className="pl-11 pr-9 py-3 border border-gray-200 rounded-full w-full focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all bg-white shadow-sm"
            value={searchQuery}
        ...
        <div className="relative" ref={sortRef}>
          ...
          {isSortDropdownOpen && (
            <div className="absolute top-full mt-2 z-10 bg-white rounded-lg shadow-lg border border-gray-100 w-48 py-1">
              <button
                className={`w-full px-4 py-2 text-sm hover:bg-orange-50 flex items-center ${
                  sortOption === "recent"
              ...
              <button
                className={`w-full text-left px-4 py-2 text-sm hover:bg-orange-50 flex items-center ${
          ...
          {isStatusDropdownOpen && (
            <div className="absolute top-full mt-2 z-10 bg-white rounded-lg shadow-lg border border-gray-100 w-48 py-1">
              ...
              >
                ...
                <span className={statusFilter === "active" ? "flex-shrink-0" : "ml-0"}>
                  Active Blogs
                </span>
              </button>
              <button
              ...
              >
                ...
                <span className={statusFilter === "inactive" ? "flex-shrink-0" : "ml-0"}>
                  Inactive Blogs
                </span>
              </button>
            </div>
      ...
      <Link
        href={"/blogs/new-blog"}
        className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-full hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px] w-full sm:w-auto justify-center"
      >
